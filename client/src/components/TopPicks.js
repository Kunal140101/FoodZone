            ...
            return(
                ...
                <div className='rounded-3xl relative'>
                    <div className='absolute w-full h-full bg-black/50 rounded-3xl text-white'>
                        ...
                        <p>{item.price}</p>
                        <button className=' border-white border-double text-white mx-2 absolute bottom-4'>
                            Add to Cart
                        </button>
                    </div>
                    <img className='h-[200px] w-full object-cover rounded-3xl hover:scale-105 ease-out duration-300' 
                    src={item.img} 
                    alt={item.title} />
                </div>
                </SplideSlide>
