  ...
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'>
            <div onClick={()=> setSideNav(!sideNav)} className='cursor-pointer' style={{display: 'inline-block'}}>
                <AiOutlineMenu size={25}/>
            </div>
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2 font-bold' style={{display: 'inline-block'}}>Food
            <span className="pl-1 font-bold text-orange-700">Zone</span>
            </h1>
        ...
        <button className='bg-orange-700 text-white hidden md:flex items-center px-6 py-2 rounded-full'>
        ...
        <h2 className='text-2xl p-4 font-bold'>Food<span className='text-orange-700 font-bold'>Zone</span></h2>
        <nav>
